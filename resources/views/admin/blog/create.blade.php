			...
			<div class="col-md-12">
				<div class="tile">
					<div class="tile-body">
						...
						<form class="blog-update-form" method="POST" action="{{route('blog-store')}}" enctype="multipart/form-data">
                          @csrf
							...
							<div class=" cst-add-new-form row">
								...
								<div class="col-lg-8 col-sm-8 col-md-8 col-xs-12">
									<div class="form-group">
										...
										<input class="form-control  @error('blog_title') is-invalid @enderror" name="blog_title" id="blog_title" value="{{ old('blog_title') }}" type="text"  aria-describedby="title" placeholder="Enter Your Blog Title">
									...
									<div class="form-group">
										...
										<input class="form-control  @error('blog_short_desc') is-invalid @enderror" name="blog_short_desc" value="{{ old('blog_short_desc') }}" id="blog_short_desc" type="text"  aria-describedby="Blog Short Description" placeholder="Enter Your Blog Short Description">
							...
							<div class=" cst-add-new-form row">
								<div class="col-lg-12 col-sm-12 col-md-12 col-xs-12">
									<div class="form-group">
										...
										<textarea id="myTextarea" class="@error('blog_long_description') is-invalid @enderror" name="blog_long_description" >{{ old('blog_long_description') }}</textarea>

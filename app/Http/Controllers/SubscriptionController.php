...
class SubscriptionController extends Controller
{
...

    {
        ...
        if($request->sort == 'mostpopular'){
            ...
            if($subscription->mostpopular_status == 'active'){
                $data = array(
                    "mostpopular_status"=>'inactive', 
                );
            }else{
                $data = array(
                    "mostpopular_status"=>'active', 
                );
            }   
        }else if($request->sort == 'explore'){
            $subscription = Subscription::where('id',$id)->first();
            if($subscription->explore_status == 'active'){
                $data = array(
                    "explore_status"=>'inactive', 
                );
            }else{
                $data = array(
        ...
        }else if($request->sort == 'newrelease'){
            $subscription = Subscription::where('id',$id)->first();
            if($subscription->newrelease_status == 'active'){
                $data = array(
                    "newrelease_status"=>'inactive', 
                );
            }else{
                $data = array(
                    "newrelease_status"=>'active', 
                );
            }   
        }else if($request->sort == 'giftsubscription'){
            $subscription = Subscription::where('id',$id)->first();
            if($subscription->giftsubscription_status == 'active'){
                $data = array(
                    "giftsubscription_status"=>'inactive', 
                );
            }else{
                $data = array(
                    "giftsubscription_status"=>'active', 
                );
            }   
        }else{
            $data = array();

...
Route::middleware(['auth:sanctum', 'updateLastActivity'])->group(function () {
    ...
    Route::get('/get-user-events', 'App\Http\Controllers\Api\UserSubscriptionController@get_user_events');
...
Route::post('/auth/reset-password', 'App\Http\Controllers\Api\NewPasswordController@reset');
    ...
    Route::post('/download-pitch-request', 'App\Http\Controllers\Api\UserController@download_pitch_request');
